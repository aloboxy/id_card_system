...
<head>
    ...
    @endphp
    <title>{{ $appSetting->election_name }} - Reset Password</title>
    ...
    <div class="login-container">
        <div class="login-card">
            <div class="logo-container">
                ...
                <p class="subtitle-text">Enter your email to receive a reset link.</p>
            </div>
            ...
            <form action="{{ route('password.email') }}" method="POST">
                ...
                <button type="submit" class="btn-signin">Send Password Reset Link</button>
            </form>
