        ...
        <form action="{{ route('roles.store') }}" method="POST" class="p-6 space-y-6">
            ...
            <div class="grid grid-cols-1 gap-6">
                <div>
                    ...
                    <input type="text" name="name" placeholder="Role Name" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm border p-2">
                </div>
                ...
                <div>
                    ...
                    @foreach($permission as $value)
                        <label class="inline-flex items-center">
                            <input type="checkbox" name="permission[]" value="{{ $value->id }}" class="rounded border-gray-300 text-indigo-600 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
