    ...
    <div class="max-w-4xl mx-auto">
        <div class="bg-white shadow rounded-lg p-6 mb-6">
            <div class="flex justify-between items-center mb-4">
                ...
                <div class="space-x-2">
                    <button onclick="startBulkGeneration()" id="btn-generate"
                    ...
                    canvas.loadFromJSON(templateData, function () {
                        ...
                        objects.forEach((obj, index) => {
                            ...
                            if (isPhoto) {
                                ...
                                // Try photo_url first (appended attribute), then photo_path (Student), then profile_photo_path (Staff)
                                const photoPath = record.photo_url || record.photo_path || record.profile_photo_path;
                                ...
                                if (photoPath) {
                                    ...
                                    console.log('No profile photo for this record');
                                }
                            }
